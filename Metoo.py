...
Mateen\033[1;92m---------------------------------Zaib----------------------------
                E R R O R - FIXED UPDATED COMMAND 0.1v
\x1b[1;96m-->YouTube  : Metoo tricker *(New channel)
\x1b[1;95m-->Facebook : Mateen
\x1b[1;94--> Github   : https://github.com/Metoohacker
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(1)
            ...
            os.system('xdg-open https://m.youtube.com/channel/g')
    else:
        print "\033[1;97mACCESS DENIED"
        os.system('xdg-open https://m.youtube.com/channel/g')
def login():
